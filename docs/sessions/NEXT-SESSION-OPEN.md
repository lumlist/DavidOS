...
7. **Four C's order rule (highest-impact open question):** does the [Nate Herk AIOS influence note](../charter/influences/2026-05-13-nate-herk-aios-course.md) resequence the 5-step path? The rule states Context → Connections → Capabilities → Cadence, in that order, and the uncomfortable insight is that our current "substrate-first" work may actually be Capability-first without operational Context or Connections in place. Tentative recommendation in the note: "Context comes before Capabilities. Before authoring more substrate items, capture David's operational context — what he sells, what's selling, what matters this quarter, current tools." Decide whether to adopt this as ADR-005/006 or to keep it as influence-under-consideration.
8. Adopt the [Nate Herk decision framework](../charter/influences/2026-05-13-nate-herk-tech-stack-and-frameworks.md) for evaluating new tools / frameworks / influences as a formal DavidOS pattern (likely ADR-005/006, or a `skill-evaluate-new-influence.md`)? The rule: ask whether the new thing solves a current pain point; if no, save the link only; if yes, test in a real workflow, time-boxed.
9. Reframe milestone tracking as **"needle moved per hour"** rather than tasks completed or hours worked? Pairs with the "20% productivity dip" framing — naming the dip explicitly defuses Frustration 1.
