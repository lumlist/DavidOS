...
`docs/sessions/drafts/parking-lot.md` is the live Parking Lot. Initialize from this template; never overwrite.
...
Three top-level sections. Append-only by source:
